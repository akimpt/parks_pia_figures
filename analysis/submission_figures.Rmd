...
```{r DA, fig.cap="**Fig x. Inner City Residential Development Application Approvals**", out.width="100%"}
...
bb <- st_bbox(inner_cities) 

basemap <- cc_location(cbind(as.numeric(bb["xmin"]), as.numeric(bb["ymin"])), buffer = 1e5)
