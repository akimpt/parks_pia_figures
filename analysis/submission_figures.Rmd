...
opts_chunk$set(cache = FALSE, warning = FALSE, echo = FALSE, message = FALSE, dpi = 1200,
...
```{r DA, fig.cap="Residential Development Applications Approved by Inner City Local Governments"}
...
```{r hex_map_arrange, fig.asp=1, fig.width=4, fig.cap="Known Parking by Inner City Local Governments"}
...
```{r hex_map_panel, fig.asp=0.35, fig.cap="Known Parking by Inner City Local Governments"}
#https://cran.r-project.org/web/packages/cartography/vignettes/cartography.html
#https://rpubs.com/dieghernan/beautifulmaps_I
pal <- viridisLite::viridis(5)
